  ...
  return (
    <>
      <div className="flex items-center justify-between px-7 py-7">
        <div className="font-medium text-lg text-black flex items-center gap-x-3">
      ...
      <div className="px-7 py-7 flex flex-col md:flex-row md:items-center md:justify-between pt-3">
        <div className="flex flex-col gap-y-2">
          <h1 className="text-4xl md:text-4xl font-semibold text-black text-center md:text-justify tracking-tighter">
            I'm {configData.name}
          </h1>
          ...
          <div className="flex items-center text-center md:text-justify justify-center md:justify-normal pt-6">
            <a href={configData.hireMeLink}>
              <button
                type="button"
                className="gap-x-1 before:ease relative overflow-hidden border border-[#000000] bg-[#050708] text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 font-medium rounded-lg text-xs px-2 py-2 text-center inline-flex items-center mr-2 mb-2"
                disabled>
                <svg
        ...
        <div className="rounded-full flex items-center justify-center md:mb-0 mt-6 md:mt-0">
          <div className="w-32 h-32 ml-2 rounded-full bg-gradient-to-b from-gray-100 to-gray-300 border-2 flex items-center justify-center">
